<?php
	...
	function pword($wid) {
		...
		$pword = $row["word"];
		echo '&laquo; <a href="http://localhost/d/'.$pword.'.html"><font color="red">'.$pword.'</font></a> ';	
	}
	//Nextword Function
	function nword($wid) {
	...
	if(isset($_POST['search'])){
		...
		if(!empty($sword)){
			header('location: http://localhost/d/'.$sword.'.html');
		}
	}
	if (isset($_GET['word'])) {		
		$sword = $_GET['word'];
	...
	<html>
		<head>
			...
			<link rel="stylesheet" href="http://localhost/d/css/style.css"/>
			<link rel="shortcut icon" href="http://localhost/d/favicon.png" />
		</head>
		<body>
			<div class="header">
